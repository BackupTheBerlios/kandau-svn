...
typedef QMutableMapIterator<OidType, ObjectHandler> ManagerObjectConstIterator;
...
typedef QMutableMapIterator<Reference, RelationHandler> ManagerRelationConstIterator;
...
typedef QMutableMapIterator<Reference, CollectionHandler> ManagerCollectionConstIterator;
*/

typedef QMap<OidType, ObjectHandler> ManagerObjectMap;
typedef QMap<OidType, ObjectHandler>::iterator ManagerObjectIterator;
typedef QMap<OidType, ObjectHandler>::const_iterator ManagerObjectConstIterator;

typedef QMap<Reference, RelationHandler> ManagerRelationMap;
typedef QMap<Reference, RelationHandler>::iterator ManagerRelationIterator;
typedef QMap<Reference, RelationHandler>::const_iterator ManagerRelationConstIterator;

typedef QMap<Reference, CollectionHandler> ManagerCollectionMap;
typedef QMap<Reference, CollectionHandler>::iterator ManagerCollectionIterator;
typedef QMap<Reference, CollectionHandler>::const_iterator ManagerCollectionConstIterator;
...
public:
	...
	void setMaxObjects( qulonglong max );
	qulonglong maxObjects() const;
	...
	static const qulonglong Unlimited = ULONG_MAX;
protected:

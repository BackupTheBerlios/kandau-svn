...
protected:
	virtual const ClassInfo* findObject( const OidType& oid, const ClassInfo *classInfo, Q3SqlCursor& cursor );
	...
	virtual bool load( const Q3SqlCursor &cursor, Object *object );
	...
	Q3ValueVector<QPair<QString,OidType> > m_removedObjects;
